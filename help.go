...
const (
	helpMessage = "ℹ️ *Info*\n_This bot is a Lightning Bitcoin wallet and can sends tips on Telegram. Simply invite it to your group. The basic unit of tips are Satoshis (sat). 100,000,000 sat = 1 Bitcoin. There will only ever be 21 Million Bitcoin._\n\n" +
		"❤️ *Donate*\n" +
